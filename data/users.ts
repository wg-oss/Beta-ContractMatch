import type { Realtor, Contractor } from "../types"
    ...
    posts: [
      {
        ...
        userId: "c2",
        content:
          "Transformed a master bathroom into a spa-like retreat with heated floors and a custom shower. #BathroomRenovation",
    ...
    posts: [
      {
        ...
        userId: "c3",
        content:
          "Built a floor-to-ceiling custom library with a rolling ladder and integrated lighting. #CustomCarpentry",
    ...
    posts: [
      {
        ...
        userId: "c5",
        content:
          "Created a resort-style backyard with a custom pool, outdoor kitchen, and fire features. #OutdoorLiving",
